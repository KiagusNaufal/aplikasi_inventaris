...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('barang-inventaris') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>{{ __('Barang Inventaris') }}</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{ route('pinjaman') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <li class="nav-item">
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('laporan.barang') }}">{{ __('Laporan Barang Inventaris') }}</a>
                <a class="collapse-item" href="{{ route('laporan.peminjaman') }}">{{ __('Laporan Peminjaman') }}</a>
                <a class="collapse-item" href="{{ route('laporan.pengembalian') }}">{{ __('Laporan Pengembalian') }}</a>
            </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('jenis-barang') }}">{{ __('Jenis Barang') }}</a>
                <a class="collapse-item" href="{{ route('vendor') }}">{{ __('Vendor') }}</a>
            </div>
            </div>
        </li>
        <!-- Divider -->
